            ...
            <ul class="navbar-nav navbar-align">
                ...
                <li class="nav-item dropdown">
                    ...
                    <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                        <img src="img/avatars/<?= $_SESSION['usuario']['avatar'] ?>" class="border border-white avatar img-fluid rounded-5 me-1" alt="Charles Hall" /> <span class="text-dark"><?= strtoupper($_SESSION['usuario']['nombre']) ?></span>
                    </a>
