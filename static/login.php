...
<body>
						...
						<div class="card">
							<div class="card-body">
								...
								<div class="text-center mt-4">
									<img class=" w-50 mb-1" src="./img/icons/icono.png" alt="">
									<!-- <h1 class="h2">Georking Business</h1> -->
									<p class="lead">
										<i>Convierte ventas en estadísticas y estadísticas en ganancias.</i>
									</p>
								</div>
								<div class="m-sm-3">
									<form action="./index.php" method="get">
										...
										<div class="mb-3">
											...
											<input class="form-control form-control-lg" onkeypress="handleKeyPress(event)" type="password" name="password" id="password" placeholder="Ingresa tu contraseña" />
										</div>
										<div class="d-grid gap-2 mt-3">
											<a onClick="ingresar()" class="btn btn-lg btn-primary color-blue">Iniciar Sesión</a>
										</div>
									</form>
								</div>
							</div>
	...
	<script>
		...
		function handleKeyPress(e) {
			// Use e.keyCode or e.which for cross-browser compatibility with older events
